				...
				*/	 
				 ...
				 */
					...
					*/
					...
					double allianceZone = foo3/4 + foo16/4 + foo29/4 + foo42/4;
					System.out.println(allianceZone);
					double autoTotes = foo4/4 + foo17/4 + foo30/4 + foo43/4;
					System.out.println(autoTotes);
					double autoCans = foo5/4 + foo18/4 + foo31/4 + foo44/4;
					System.out.println(autoCans);
					double gamePieces = foo6/4 + foo19/4 + foo32/4 + foo45/4;
					System.out.println(gamePieces);
					double toteHeight = foo7/4 + foo20/4 + foo33/4 + foo46/4;
					System.out.println(toteHeight);
					double platformCans = foo8/4 + foo21/4 + foo34/4 + foo47/4;
					System.out.println(platformCans);
					double platformTotes = foo9/4 + foo22/4 + foo35/4 + foo48/4;
					System.out.println(platformTotes);
					double maxHeight = foo10/4 + foo23/4 + foo36/4 + foo49/4;
					System.out.println(maxHeight);
					double platformCansAndTotes = foo11/4 + foo24/4 + foo37/4 + foo50/4;
					System.out.println(platformCansAndTotes);
					double litterInCan = foo12/4 + foo25/4 + foo38/4 + foo51/4;
					System.out.println(allianceZone);
				//	TODO Alter Printer
