				...
				*/	 
				 ...
				 */
					...
					*/
					...
					double allianceZone = foo3/5 + foo16/5 + foo29/5 + foo42/5 + foo55/5;
					System.out.println(allianceZone);
					double autoTotes = foo4/5 + foo17/5 + foo30/5 + foo43/5 + foo56/5;
					System.out.println(autoTotes);
					double autoCans = foo5/5 + foo18/5 + foo31/5 + foo44/5 + foo57/5;
					System.out.println(autoCans);
					double gamePieces = foo6/5 + foo19/5 + foo32/5 + foo45/5 + foo58/5;
					System.out.println(gamePieces);
					double toteHeight = foo7/5 + foo20/5 + foo33/5 + foo46/5 + foo59/5;
					System.out.println(toteHeight);
					double platformCans = foo8/5 + foo21/5 + foo34/5 + foo47/5 + foo60/5;
					System.out.println(platformCans);
					double platformTotes = foo9/5 + foo22/5 + foo35/5 + foo48/5 + foo61/5;
					System.out.println(platformTotes);
					double maxHeight = foo10/5 + foo23/5 + foo36/5 + foo49/5 + foo62/5;
					System.out.println(maxHeight);
					double platformCansAndTotes = foo11/5 + foo24/5 + foo37/5 + foo50/5 + foo63/5;
					System.out.println(platformCansAndTotes);
					double litterInCan = foo12/5 + foo25/5 + foo38/5 + foo51/5 + foo64/5;
					System.out.println(allianceZone);
				//	TODO Alter Printer
