				...
				if(choice2.toUpperCase().equals("MINE")){
					...
					if(choice3.toUpperCase().equals("JOIN")){
						...
						if(choice4.toUpperCase().equals("NORTH")){
							System.out.println("You run as fast as you can to the north.\nYou eventually end up near a farm.\nYou must now either choose to ask for hospitality or run past the farm.\nNote: You are wanted for escaping the prison.");
							}
						...
						if(choice4.toUpperCase().equals("EAST")){
							...
							if(yesno3.toUpperCase().equals("NO")){
								...
								else if(yesno3.toUpperCase().equals("YES")){
									playagain=true;
								}
						}
							if(choice4.toUpperCase().equals("WEST")){
									System.out.println("You begin to run to the West, until you come upon a strange object on the ground. Continue or investigate?");
									String choice5 = in.next();
									if(choice5.toUpperCase().equals("INVESTIGATE")){
										System.out.println("You begin to investigate the object, but trip over a tree root and land on it. You then realise it is a spike. Play again?");
										String yesno4 = in.next();
										if(yesno4.toUpperCase().equals("NO")){
											playagain = false;
										}
											else if(yesno4.toUpperCase().equals("YES")){
												playagain=true;
											}
									}
											else if(choice5.toUpperCase().equals("CONTINUE")){
												System.out.println("You begin to walk past the object, but trip over a fly. You land on the object, and soon realise it is a spike. Play again?");
											String yesno5 = in.next();
											if(yesno5.toUpperCase().equals("NO")){
												playagain = false;
											}
												else if(yesno5.toUpperCase().equals("YES")){
													playagain=true;
												}
											}
